...
jar:
	cd build && jar -cfe ../hydra.jar MainDriver h2PFoundation h2PVisitors xmi2hil h2PNodes umlModel xmiParser Main.class && cd ..
...
doc:
	...
	jjdoc -ONE_TABLE=true -OUTPUT_FILE=docs/grammars/HILParser.html src/h2PParser/HILParser.jj
	jjdoc -ONE_TABLE=true -OUTPUT_FILE=docs/grammars/UMLExpr.html src/h2PParser/UMLExpr.jj